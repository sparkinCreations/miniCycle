...
// ============================================================================
// (Interrupted-test recovery removed.) The in-app test runner now runs on a
// separate origin (test.minicycle.app); its storage is isolated from real user
// data by the browser, so there is nothing to recover at boot.
// ============================================================================
