...
export const THEME_DEFINITIONS = {
    ...
    'habit-tracker': {
        ...
        labels: {
            ...
            'empty.noTasksHint':           'Press the + button to open the habit bar and add your first habit',
            'empty.noTasksHintVisible':    'Type your first habit in the bar above and press Add',
            'empty.noTasksHintFocus':      'Open the {menuIcon} menu at the top and tap {showHide} to show the habit bar',
        ...
        colorPreset: {
            ...
            menuText:             '#3d1a00',
            // Menu action buttons (Welcome Screen / Focus View / Close). Its OWN key
            // because no existing preset colour works across all themes: completeBtn
            // and clearBtn carry white text at only 2.4-3.0:1 on fitness and cleaning.
            // deep amber-brown — white text 7.14:1.
            menuAccent:           '#8a4513',
    ...
    fitness: {
        ...
        labels: {
            ...
            'empty.noTasksHint':           'Press the + button to open the exercise bar and add your first exercise',
            'empty.noTasksHintVisible':    'Type your first exercise in the bar above and press Add',
            'empty.noTasksHintFocus':      'Open the {menuIcon} menu at the top and tap {showHide} to show the exercise bar',
            'empty.noTasksHintFocusVisible': 'Type your first exercise in the bar above and press Add',
            'empty.noTasksHintSwipe':      'Swipe to Routine to add your first exercise',
    ...
    scholar: {
        ...
        labels: {
            ...
            'empty.noTasksHint':           'Press the + button to open the topic bar and add your first topic',
            'empty.noTasksHintVisible':    'Type your first topic in the bar above and press Add',
            'empty.noTasksHintFocus':      'Open the {menuIcon} menu at the top and tap {showHide} to show the topic bar',
            'empty.noTasksHintFocusVisible': 'Type your first topic in the bar above and press Add',
            'empty.noTasksHintSwipe':      'Swipe to Routine to add your first topic',
    ...
    cleaning: {
        ...
        labels: {
            ...
            'empty.noTasksHint':           'Press the + button to open the chore bar and add your first chore',
            'empty.noTasksHintVisible':    'Type your first chore in the bar above and press Add',
            'empty.noTasksHintFocus':      'Open the {menuIcon} menu at the top and tap {showHide} to show the chore bar',
            'empty.noTasksHintFocusVisible': 'Type your first chore in the bar above and press Add',
            'empty.noTasksHintSwipe':      'Swipe to Routine to add your first chore',
