...
const ALL_MODULES = [
    ...
    'taskDOMPatch', 'debugMode', 'iconInit', 'icons', 'keyboardNav', 'collapsibleSections', 'educationalTips', 'routineSwitcherThemePicker', 'longPressHint', 'mcycPayload', 'nameUtils', 'styleValidators', 'cycleMode', 'bootSw',
