...
const ALL_MODULES = [
    ...
    'dataSanitizer', 'tipArchive', 'titleScreen', 'storageUtils', 'storagePersistence', 'achievementsManager', 'historyManager',
