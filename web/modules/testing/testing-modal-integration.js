...
const TEST_MODULES = {
    ...
    'cyclemanager': { name: 'CycleManager', file: 'cycleManager.tests.js', function: 'runCycleManagerTests', count: 24 },
    'state': { name: 'State Management', file: 'state.tests.js', function: 'runStateTests', count: 41 },
    'appinit': { name: 'AppInit', file: 'appInit.tests.js', function: 'runAppInitTests', count: 29 },
    'namespace': { name: 'Namespace API', file: 'namespace.tests.js', function: 'runNamespaceTests', count: 75 },
