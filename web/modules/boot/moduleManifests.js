...
export const MODULE_MANIFESTS = {
    ...
    undoRedoManager: {
        ...
        optionalDeps: ['logHistoryEvent', 'refreshHistoryIfOpen', 'updateRecurringInfoLink', 'updateHelpWindow', 'syncModeFromToggles', 'refreshThemeLabels', 'updateRecurringPanel', 'AppGlobalState'],
    ...
    historyManager: {
        ...
        requires: ['appInit', 'AppState', 'showNotification'],
        optionalDeps: ['safeAddEventListener', 'showConfirmationModal', 'updateStatsPanel', 'clearedTasksManager', 'addTask', 'showHistoryTourNotification', 'showClearedTasksTourNotification'],
